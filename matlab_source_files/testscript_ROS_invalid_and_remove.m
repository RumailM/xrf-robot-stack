...
backOffFlag = 1; % 1 for back off between scanning points, 0 for not
offset = 0.05; % offset how far it should back off 0.05 = 5 cm

%reduce the number of scanning points, for testing purposes, makes the scan
%more sparese
reduceFlag = 0; % if 1, make sparse, otherwise use all scanning points
reduceFactor = 10; % take every reduceFactor-th(10th for example) point, discard rest
